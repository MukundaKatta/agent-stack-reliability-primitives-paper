...
% Define a JavaScript dialect for listings since the bundled language list omits it.
\lstdefinelanguage{JavaScriptLite}{
  morekeywords={await, async, const, let, var, function, return, if, else, for, of, in, new, import, from, throw, try, catch, while, class, extends, this},
  morecomment=[l]{//},
  morestring=[b]',
  morestring=[b]",
  sensitive=true,
...
\begin{lstlisting}[language=JavaScriptLite,basicstyle=\ttfamily\small,frame=single,framesep=4pt,xleftmargin=0pt]
